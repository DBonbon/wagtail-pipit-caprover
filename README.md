...
2. Include this ip on your hosts-file
    ...
    ```
    127.0.0.1 pipit.leacards.site.test
    ```

    On windows you can run this command to append it:

    ```
    echo 127.0.0.1 pipit.leacards.site.test >> c:\windows\System32\drivers\etc\hosts
    ```
...
4. Generate ssl certs for local development
    ```
    mkcert --cert-file docker/files/certs/cert.pem --key-file docker/files/certs/cert-key.pem pipit.leacards.site.test
    ```
...
7. Install and start frontend
    ...
    npm run dev
    ```
8. Visit your site on: [https://pipit.leacards.site.test:8082](https://pipit.leacards.site.test:8082)
    - ...or login to [https://pipit.leacards.site.test:8082/wt/cms](https://pipit.leacards.site.test:8082/wt/cms) (Username: `admin` and password: `admin`)
