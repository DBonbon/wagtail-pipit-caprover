...
readonly STAGE_HOST=deploy@stage-pipit.leacards.site
readonly PROD_HOST=deploy@pipit.leacards.site
...
ssh $STAGE_HOST "$manage_prefix python manage.py change_site_domain --site_id=1 --new_site_domain='stage-pipit.leacards.site'"
